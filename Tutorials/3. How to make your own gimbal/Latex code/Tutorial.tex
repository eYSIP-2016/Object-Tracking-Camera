...
\begin{document}
	...
	\section{Experiment}
		...
		\begin{enumerate}
			...
			\end{itemize}
			\begin{center}
				\includegraphics[scale=0.3]{../Images/Brushless_Gimbal_Motor.jpg}
			\end{center}
			\begin{center}
				\textbf{Figure 11: Quanum 2208 Precision Brushless Gimbal Motor (GoPRO size 100-200g) (Courtesy: hobbyking.com)}
			\end{center}
			%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
			\item \textbf{Storm 32 3 Axis Brushless Gimbal Controller:} It is used to control motors.
			...
			\end{center}
			\begin{center}
				\textbf{Figure 12: Storm 32 3 Axis Brushless Gimbal Controller (Courtesy: hobbyking.com)}
			\end{center}
			%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
			\item \textbf{DJI H3-3D Standard Version Part42 Damping Shock Absorber Ball:} We require 4 balls to stay gimbal shock free. Figure 13 shows one image of absorber balls. It can be found here,
			\newline
