...
public:
    ...
    void update(const std::vector<int> &fern, const int &C, const int &N);
    float measure_forest(const std::vector<int> &fern);
    void trainF(const std::vector<std::pair<std::vector<int>,int> > &ferns, const int &resample);
